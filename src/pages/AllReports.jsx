...
const AllReports = () => {
    ...
    return (
        <div className="max-w-screen-lg mx-auto p-4 mt-10">
            <h1 className="text-2xl font-bold text-gray-800 mb-4">All Reports</h1>
                ...
                <div className="grid md:grid-cols-3 grid-cols-1 gap-4">
                    {filteredReports.map(report => (
                        <div key={report._id} className="border border-gray-300 rounded-lg p-4 shadow-sm hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div className="text-gray-600 mt-2"><span className='font-bold'>By</span> {report.user_name}</div>
